...
class MotorController:
    ...
    def set_motor_speed(self, pwm_channel, direction_pin1, direction_pin2, speed, reverse=False):
        # Debug: print the pwm_channel
        print(f"Received pwm_channel: {pwm_channel}")
        ...
        if speed == 0:
            ...
            if _pigpio:
                # Determine pwm_pin based on pwm_channel
...
#         #### TEMPORARY CHANGE THE ROTATION BACK THE OTHER WAY###############
#         angular_velocity=-angular_velocity
#         """ Sets the velocity of the robot based on linear and angular velocity. """
